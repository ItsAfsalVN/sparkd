...
part 'create_new_gig_event.dart';
part 'create_new_gig_state.dart';

class CreateNewGigBloc extends Bloc<CreateNewGigEvent, CreateNewGigState> {
  CreateNewGigBloc() : super(const CreateNewGigState()) {
  ...
  void _onTitleChanged(GigTitleChanged event, Emitter<CreateNewGigState> emit) {
    emit(state.copyWith(title: event.title));
  }

  void _onDescriptionChanged(
    GigDescriptionChanged event,
    Emitter<CreateNewGigState> emit,
  ) {
  ...
  void _onPriceChanged(GigPriceChanged event, Emitter<CreateNewGigState> emit) {
  ...
  void _onTagsChanged(GigTagsChanged event, Emitter<CreateNewGigState> emit) {
